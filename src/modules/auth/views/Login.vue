  ...
  computed: {
    texts () {
      return this.isLogin
        ...
        : { toolbar: 'Criar Conta', button: 'Ja tenho uma conta' }
    },
    emailErrors () {
      const errors = []
      const email = this.$v.user.email
      if (!email.$dirty){ return errors }
      !email.required && errors.push('Email � obrigat�rio!')
      !email.email && errors.push('Insira um email v�lido!')
      return errors
    },
    nameErrors () {
      const errors = []
      const password = this.$v.user.name
      if (!name.$dirty){ return errors }
      !name.required && errors.push('O Nome � obrigat�rio!')
    ...
    passwordErrors () {
      ...
      !password.required && errors.push('Senha � obrigat�ria!')
